...
<title>學習平台後台管理系統</title>
  ...
  <link href="${contextRoot}/css/chou/fieldset.css" rel="stylesheet">
  <!-- Favicons -->
        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="input-group mb-3">
				<form:form action="${contextRoot}/course/insert" modelAttribute="course" method="post" enctype="multipart/form-data">
            	<input type="hidden" name="pId" value="${product.productId}">
					<input type="hidden" name="courseId" style="display:none"/>
					...
					<div class="input-group-prepend">
						...
						<input class="form-control" type="file" name="coursePicture"/><br>
