...
<title>THUNDER後台管理系統</title>
  ...
  <!-- Vendor CSS Files -->
  <link href="${contextRoot}/css/thunder/backendMessageBox.css" rel="stylesheet">
...
<!--           </ul> -->
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
     ...
     <jstl:forEach var="memberEx" items="${list}">
    <div class="container">
      <img src="${memberEx.memberPhoto}" alt="Avatar" style="width: 95px;height:90px" />
      
      <p>
      <span style="font-size:18px">會員姓名：${memberEx.memberName}</span>
      <span id="rate" class="rate">
      <jstl:choose>
		<jstl:when test="${memberEx.starCounts==5}">
		<i class="rateStar">★</i><i class="rateStar">★</i><i class="rateStar">★</i><i class="rateStar">★</i><i class="rateStar">★</i>
		</jstl:when>
		<jstl:when test="${memberEx.starCounts==4}">
		<i class="rateStar">★</i><i class="rateStar">★</i><i class="rateStar">★</i><i class="rateStar">★</i><i>★</i>
		</jstl:when>
		<jstl:when test="${memberEx.starCounts==3}">
		<i class="rateStar">★</i><i class="rateStar">★</i><i class="rateStar">★</i><i>★</i><i>★</i>
		</jstl:when>
		<jstl:when test="${memberEx.starCounts==2}">
		<i class="rateStar">★</i><i class="rateStar">★</i><i>★</i><i>★</i><i>★</i>
		</jstl:when>
		<jstl:when test="${memberEx.starCounts==1}">
		<i class="rateStar">★</i><i>★</i><i>★</i><i>★</i><i>★</i>
		</jstl:when>
		</jstl:choose>
      </span>
      <span style="font-size:18px">　　　　評論時間：<fmt:formatDate value="${memberEx.feedbackTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
      </p>
      <p>${memberEx.feedbackContent}</p>
    </div>
     </jstl:forEach>
