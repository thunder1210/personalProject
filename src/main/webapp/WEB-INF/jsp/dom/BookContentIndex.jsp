...
<link href="${contextRoot}/backendSystem/assets/css/style.css"
	rel="stylesheet">
<link href="${contextRoot}/css/dom/table.css" rel="stylesheet">
<style type="text/css">
		...
		<nav class="header-nav ms-auto">
			<ul class="d-flex align-items-center">
				...
				<li class="nav-item dropdown pe-3">
					...
					<!--             </li> --> <!--             <li> --> <!--               <a class="dropdown-item d-flex align-items-center" href="users-profile.html"> -->
					<!--                 <i class="bi bi-person"></i> --> <!--                 <span>閒置</span> -->
					<!--               </a> --> <!--             </li> --> <!--             <li> -->
					<!--               <hr class="dropdown-divider"> --> <!--             </li> -->

					<!--             <li> --> <!--               <a class="dropdown-item d-flex align-items-center" href="users-profile.html"> -->
					<!--                 <i class="bi bi-gear"></i> --> <!--                 <span>閒置</span> -->
					<!--               </a> --> <!--             </li> --> <!--             <li> -->
					<!--               <hr class="dropdown-divider"> --> <!--             </li> -->

					<!--             <li> --> <!--               <a class="dropdown-item d-flex align-items-center" href="pages-faq.html"> -->
					<!--                 <i class="bi bi-question-circle"></i> --> <!--                 <span>閒置</span> -->
					<!--               </a> --> <!--             </li> --> <!--             <li> -->
					<!--               <hr class="dropdown-divider"> --> <!--             </li> -->

					<!--             <li> --> <!--               <a class="dropdown-item d-flex align-items-center" href="#"> -->
					<!--                 <i class="bi bi-box-arrow-right"></i> --> <!--                 <span>閒置</span> -->
					<!--               </a> --> <!--             </li> --> <!--           </ul> -->
				...
				<div class="col-lg-8">
					...
					<div class="container">
						...
						<tbody>
							...
							<jstl:forEach items="${bookContent}" var="bookContent">
								<tr>
									<td>${bookContent.bookChapter}</td>
									<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss a EEEE" value="${bookContent.bookDate}"/></td>
									<td class="bookContentItem">${bookContent.content}</td>
									<td><img alt=""
										src="${contextRoot}/bookContentPhoto?id=${bookContent.bookContentId}"></td>
										<td>
											<form action="${contextRoot}/bookContentDelete" onclick="myFunction"  method="post">
  											<input name="_method" type="hidden" value="delete"/>
  											<input name="bookContentId" type="hidden" value="${bookContent.bookContentId}"/>
  											<input type="submit" class="btn btn-danger btn-sm "  value="刪除">
  											</form>
										</td>
										
										<td>
											<form action="${contextRoot}/EditContent"  method="get" enctype='multipart/form data'>
  											<input name="bookContentId" type="hidden" value="${bookContent.bookContentId}"/>
...
<!-- 										</td> -->
						...
						<a href="${contextRoot}/bookContentAdd">新增文章/章節</a>
						</div>	
					</div>
	...
	<script src="${contextRoot}/backendSystem/assets/js/main.js"></script>
		...
		function sendDeleteAjax(msgID){
			if (confirm(text) == true) {
				...
				.catch(err =>{
				    ...
				    window.location.href = 'http://localhost:8080/my-app/message/mix'
				})
			}
		}
		function myFunction(book) {
		  let textUrl= "DeleteEmp?empno="+Id;
		  let text = "確定刪除這筆資料?";
		  if (confirm(text) == true) {
			 /// axios
		  } 
		...
		$(function(){
		    ...
		    $(".bookContentItem").each(function(i){
