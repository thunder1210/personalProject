...
public interface MemberExperienceRepository extends JpaRepository<MemberExperience, Integer> {
	...
	@Query(value = "Select memberexperience.*, member.MemberPhoto, member.MemberName from memberexperience inner join member on member.MemberId = FKmemberId", nativeQuery = true)
