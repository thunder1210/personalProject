...
<title>學習平台後台管理系統</title>
  ...
  <!-- Vendor CSS Files -->
  <link href="${contextRoot}/css/thunder/backendSystemMemList.css" rel="stylesheet">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">全部會員</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
     ...
     <section class="section dashboard">
      <div class="row">
			...
			<table class="table">
				...
				<tbody>
          <jstl:forEach var="member" items="${mlist}">
					<tr>
						<td>
							<div class="user-info">
								<div class="user-info__img">
									<img src="${member.memberPhoto}" alt="User Img" onerror="this.src='${contextRoot}/images/thunder/unknown.jpg'">
								</div>
								<div class="user-info__basic">
									<h5 class="mb-0">${member.memberAccount}</h5>
						...
						<td>
              <jstl:choose>
                <jstl:when test="${member.memberStatus=='啟用'}"><span class="active-circle bg-success"></span> ${member.memberStatus}</jstl:when>
                <jstl:otherwise><span class="active-circle bg-danger"></span> ${member.memberStatus}</jstl:otherwise>
            </jstl:choose>
						</td>
						<td>${member.memberGender}</td>
						<td>${member.memberTelephone}</td>
						<td>${member.memberEmail}</td>
						<td>
							<button class="btn btn-primary btn-sm" onclick="window.location.href='http://localhost:8080/onlinelearning/BackendSystem/findMember?mId=${member.memberId}'">查看</button>
						</td>
						<td>
							<div class="dropdown open">
								...
								<div class="dropdown-menu" aria-labelledby="triggerId1">
									<a class="dropdown-item" href="http://localhost:8080/onlinelearning/BackendSystem/findMember?mId=${member.memberId}"><i class="fa fa-pencil mr-1"></i> Edit</a>
									<a class="dropdown-item text-danger" href="http://localhost:8080/onlinelearning/BackendSystem/deletemember?mId=${member.memberId}"><i class="fa fa-trash mr-1"></i> Delete</a>
								</div>
							</div>
						</td>
					</tr>
