        ...
        <div class="col-lg-8">
          <div class="row">
			...
			<div class="input-group mb-3">
				<form:form action="${contextRoot}/course/courseEdited" modelAttribute="course" method="post" enctype="multipart/form-data">
					<input type="hidden" value="${course.courseId}" readonly="readonly" name="courseId" style="display: none;"/><br>
					<div class="input-group-prepend">
						<span class="tspan">課程名稱</span>
						<input class="form-control" type="text" value="${course.courseName}" name="courseName"/><br>
					</div>
					<div class="input-group-prepend">
						...
						<img width="200" />
						<input class="form-control" type="file" name="theCoursePicture" accept="image/*"/><br>
					</div>
					<div class="input-group-prepend">
						<span class="tspan">課程分類</span>
						<input class="form-control" type="text" value="${course.courseType}" name="courseType"/><br>
					</div>
				<button class="btn btn-primary" type="submit">送出</button>
				</form:form>
				
				<jstl:forEach items="${chapter}" var="cChapter">
				<div class="ChapterAndContent">
				<form:form action="${contextRoot}/course/chapterEdited" modelAttribute="chapter" method="post">
				
				<input type="hidden" style="display:none" value="${cChapter.courseChapterId}" name="courseChapterId">
					<div class="input-group-prepend">
						<span class="tspan">章節主題</span>
						<input class="form-control" type="text" value="${cChapter.courseChapter}" name="courseChapter"/><br>
					</div>
					<div class="input-group-prepend">
						<span class="tspan">章節內容</span>
						<input class="form-control" type="text" value="${cChapter.courseContent}" style="width: 600px;height: 200px;" name="courseContent"><br>
					</div>
					<div class="input-group-prepend">
						<span class="tspan">是否為影片</span>
						<input class="form-control" type="text" value="${cChapter.videoOrNot}" name="videoOrNot"><br>
					</div>
				<button class="btn btn-primary" type="submit">章節修改</button>
				</form:form>
				<form action="${contextRoot}/course/chapterDelete" method="post">
						<input name="_method" value="delete" type="hidden" /> 
						<input name="courseChapterId" value="${cChapter.courseChapterId}" type="hidden" /> 
						<input type="submit" class="btn btn-danger" onclick="return confirmDelete()" value="刪除此章節" />
				</form>
				</div>
				</jstl:forEach>
				<br>
