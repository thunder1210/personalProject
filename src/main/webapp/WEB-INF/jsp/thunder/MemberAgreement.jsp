...
<link href="${contextRoot}/css/thunder/memberAgreement.css" rel="stylesheet">
</head>
<body>
	<div class="theContainerBox"><a href="${contextRoot}/">
	<img width="150px" src="${contextRoot}/images/thunder/cuttedLogo.jpg" /></a></div>
	<div class="outbox">
		<h1 class="theAgreementH1">線上教學平台會員服務同意條款</h1>
		<textarea class="theArea" cols="30" rows="27" >
...
● 會員基本資料(ex:住址，電話及其他登錄資料)有變更時，請不定期更新相關個人資料，確保其正確及完整性。若您提供的資料有錯誤或不符等現象，
本網站有權暫停或終止您的帳號，並拒絕您繼續使用本服務。
...
● 會員同意並授權本網站，得為提供個人化服務或相關加值服務之目的，提供所需之會員資料給合作單位(第三者)做約定範圍內之運用，
如會員不同意將其資料列於合作單位(第三者)產品或服務名單內，可通知本網站於名單中刪除其資料，並同時放棄其本網站以外之購物優惠或獲獎權利。
● 同時為提供行銷、市場分析、統計或研究、或為提供會員個人化服務或加值服務之目的，會員同意本公司、或本公司之策略合作夥伴，
得記錄、保存、並利用會員在本網站所留存或產生之資料及記錄，同時在不揭露各該資料之情形下得公開或使用統計資料。
...
●  為避免惡意情事發生致使會員應享權益損失，當會員通知本公司停止會員身份時，本公司將再次以電子郵件確認無誤後，再進行註銷會員資格。
			...
			<div class="iWillAgree">
				<input id="agreeCheck" type="checkbox" />我已詳閱以上會員服務條款，並同意遵守
			</div>
		<div class="iWillAgree2">
			<button id="sendNextStep" class="btn" >繼續註冊</button>
		</div>
		<div class="iWillAgree3">
			<button class="btn" onclick="location.href='${contextRoot}/'">　返回　</button>
		</div>
	</div>
	<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
	<script src="http://code.jquery.com/jquery-1.11.3.min.js"></script>
	<script src="${contextRoot}/js/thunder/Agreement.js"></script>
	<script src="${contextRoot}/js/thunder/AgreementClick.js"></script>
