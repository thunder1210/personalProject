...
<title>學習平台後台管理系統</title>
  ...
  <link href="${contextRoot}/css/thunder/memberBackendSystemUpdate.css" rel="stylesheet">
</head>
<body>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="${contextRoot}/product/productcreate">
              <i class="bi bi-circle"></i><span>商品上架</span>
            </a>
          </li>
          <li>
            <a href="${contextRoot}/products/search">
              <i class="bi bi-circle"></i><span>搜尋商品</span>
            </a>
          </li>
                    <li>
        ...
        <div class="container rounded bg-white mt-5 mb-5">
          <div class="row">
              <div class="col-md-3 border-right">
                  ...
                  <img class="rounded-circle mt-5" width="200px" src="${theOne.memberPhoto}" onerror="this.src='${contextRoot}/images/thunder/unknown.jpg'">
                  <span class="font-weight-bold" style="font-size: 30px;">${theOne.memberName}</span><span class="text-black-50">${theOne.memberEmail}</span><span> </span></div>
              </div>
              <div class="col-md-5">
                  <div class="p-3 py-5">
                      <div class="d-flex justify-content-between align-items-center mb-3">
                          <h4 class="text-right">會員詳細資料</h4>
                      </div>
                      <form:form action="${contextRoot}/BackendSystem/updateMemberAndWrite"
                      modelAttribute="emptyMemberModel" enctype="multipart/form-data"
                      method="post">
                      <!-- //////////////////////// -->
                      <input type="hidden" path="MemberId" name="MemberId" id="MemberId" value="${theOne.memberId}"></input>
                       <!-- //////////////////////// --> <!-- //////////////////////// -->
                      <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">姓名</label><input name="MemberName" type="text" class="form-control" value="${theOne.memberName}"></div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">暱稱</label><input name="NickName" type="text" class="form-control" value="${theOne.nickName}"></div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">密碼</label><input readonly="readonly" type="text" class="form-control" style="heightL:100px;font-size:12px;word-break:break-all"  value="${theOne.memberPassword}"></div>
                      </div>
                      <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">性別</label><input name="MemberGender" type="text" class="form-control" value="${theOne.memberGender}"></div>
                        </div>
                        <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">年齡</label><input name="MemberAge" type="text" class="form-control" value="${theOne.memberAge}"></div>
                        </div>
                        <div class="row mt-2">
                         <div class="col-md-12"><label class="labels">信箱</label><input name="MemberEmail" type="text" class="form-control" value="${theOne.memberEmail}"></div>
                        </div>
                        <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">地址</label><input name="MemberAddress" type="text" class="form-control" value="${theOne.memberAddress}"></div>
                        </div>
                        <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">電話</label><input name="MemberTelephone" type="text" class="form-control" value="${theOne.memberTelephone}"></div>
                        </div>
                        <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">身分證字號</label><input name="IdentityNumber" type="text" class="form-control" value="${theOne.identityNumber}"></div>
                        </div>
                        <div class="row mt-2">
                          <div class="col-md-12"><label class="labels">教育程度</label><input name="MemberEducated" type="text" class="form-control" value="${theOne.memberEducated}"></div>
                        </div>
                        <button style="margin-top:10%;margin-left: 26%;margin-bottom: 3%;" class="sendSendBtn" type="button" onclick="location.href='${contextRoot}/BackendSystem/memberList'">返回</button><button style="margin-top:10%;margin-left: 7%;margin-bottom: 3%;" class="sendSendBtn" type="submit">保存修改</button>
                        </form:form>
                      </div>
                  </div>
              </div>
