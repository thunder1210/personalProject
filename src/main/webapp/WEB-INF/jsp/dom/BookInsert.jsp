...
<!--           </ul> -->
  ...
  <main id="main" class="main">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
           ...
           <h1>BookInsert</h1>
           <form action="${contextRoot}/book/insert" method="post" enctype="multipart/form-data">
    <br>
    ...
    <br>
    <label for="bookPhoto">BookPhoto:</label>
    <input type="file" name="bookPhoto" id="photoFileInput">
    <br>
