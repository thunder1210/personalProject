...
<!--           <div class="row"> -->
            ...
            <table class="table" style="border: solid 1px #ddd; border-radius: 30px; text-align: center;" id="Ctable">
			<thead class="thead-light" style="background-color: #ddd">
...
<!-- 					<td>課程編碼</td> -->
		...
		<jstl:forEach items="${course.content}" var="course">
			<tr>
...
<!--         </div>End Left side columns -->
        ...
        <div class="col-lg-4">
            <ul class="pagination">
              <jstl:if test="${currentPage > 1}"><li class="page-item"><a href="${contextRoot}/course/admin?p=${currentPage-1}" class="page-link">Previous</a></li></jstl:if>
		          <jstl:forEach var="pageNumber" begin="1" end="${course.totalPages}">
		            <li class="page-item"><a href="${contextRoot}/course/admin?p=${pageNumber}" class="page-link">${pageNumber}</a></li>
		          </jstl:forEach>
              <li class="page-item"><jstl:if test="${currentPage < course.totalPages}"><a href="${contextRoot}/course/admin?p=${currentPage+1}" class="page-link">Next</a></jstl:if></li>
  			</ul>
