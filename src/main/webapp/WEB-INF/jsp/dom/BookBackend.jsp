						...
						<tbody>
							...
							<jstl:forEach items="${books}" var="book">
								<tr>
									...
									<td>${book.bookType}</td>
									<td><img alt=""
										src="${contextRoot}/book/photo?id=${book.bookid}"></td>
										<td>
											<form action="${contextRoot}/book/delete" onclick="myFunction"  method="post">
										...
										<td>
											<form action="${contextRoot}/book/edit"  method="get" enctype='multipart/form data'>
  											<input name="bookId" type="hidden" value="${book.bookid}"/>
...
<!-- 										</td> -->
						...
						<a href="${contextRoot}/book/add">新增書籍</a>
						</div>	
					</div>
