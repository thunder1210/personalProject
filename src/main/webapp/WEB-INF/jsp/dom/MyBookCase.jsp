      ...
      <section>
        <div class="container">
         <jstl:forEach var="book" items="${book.content}">
      		...
      		<div>
				...
				<jstl:choose>
					<jstl:when test="${ book.number != pageNumber-1 }">
					    <a href="${contextRoot}/book/page?p=${pageNumber}">${pageNumber}</a>
					</jstl:when>
      	...
      	<form action="${contextRoot}/book/findBooksByName" class="d-flex" role="search" method="get" enctype="multipart/form-data">
