...
<!--             </li> -->
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
		...
		<form action="${contextRoot}/products/postadd" method="post"
			enctype="multipart/form-data" class="row g-3" id="myformid">
			...
			<div class="flex">
				...
				<input type="hidden" name="productSelve" class="form-control"
					id="inputselve"></input>
				<div class="form-check form-check-inline">
    ...
    <button  class="btn btn-primary" id="create">新增</button>
		<br>
					<a href="${contextRoot}/product/productlist"><button  class="btn btn-primary" id="change">返回</button></a>
