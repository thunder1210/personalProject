						...
						<nav class="header-nav ms-auto">
							<ul class="d-flex align-items-center">
								...
								<li class="nav-item dropdown pe-3">
									...
									<%-- <img src="${contextRoot}/backendSystem/assets/img/profile-img.jpg"
					...
					<aside id="sidebar" class="sidebar">
						...
						<ul class="sidebar-nav" id="sidebar-nav">
							...
							<li class="nav-item"><a class="nav-link collapsed" href="pages-blank.html"> <i
										class="bi bi-file-earmark"></i> <span>閒置空模塊</span>
								</a></li>
							<!-- End Blank Page Nav -->
										...
										<div class="container">
											<div class="d-flex">
												<form action="${contextRoot}/products/search" method="get">
													...
													<button type="submit"
														class="btn btn-outline-dark moveRight">查詢</button>
												</form>
											</div>
											<br> <a href="${contextRoot}/product/productcreate"><span
													...
													<jstl:forEach var="product" items="${allProducts}">
														<tr>
															...
															<td scope="col">
																...
																<div>
																	<form action="${contextRoot}/insertCorB" method="get">
																		<input type="hidden" value="${product.productId}" name="id1">
																	<jstl:choose>
																		<jstl:when test="${empty product.getCourse()}">
																			<button type="submit" class="btn btn-primary">新增商品內容</button>
																		</jstl:when>
																		<jstl:otherwise>
																			<button type="submit" class="btn btn-secondary">修改商品內容</button>
																		</jstl:otherwise>
																	</jstl:choose>
																	</form>
																</div>
